...
public class SeparableEnemySolverTests {
    ...
    public void input1() throws FileNotFoundException {
        SeparableEnemySolver solver = new SeparableEnemySolver("src/CS61B-sp19/clab9/input/party1");
        assertEquals(true, solver.isSeparable());
    }

    @Test
    public void input2() throws FileNotFoundException {
        SeparableEnemySolver solver = new SeparableEnemySolver("src/CS61B-sp19/clab9/input/party2");
        assertEquals(true, solver.isSeparable());
    }

    @Test
    public void input3() throws FileNotFoundException {
        SeparableEnemySolver solver = new SeparableEnemySolver("src/CS61B-sp19/clab9/input/party3");
        assertEquals(false, solver.isSeparable());
    }

    @Test
    public void input4() throws FileNotFoundException {
        SeparableEnemySolver solver = new SeparableEnemySolver("src/CS61B-sp19/clab9/input/party4");
        assertEquals(false, solver.isSeparable());
    }
